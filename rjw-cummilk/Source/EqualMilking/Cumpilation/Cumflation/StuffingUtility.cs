...
namespace Cumpilation.Cumflation
{
    public class StuffingUtility
    {
        ...
        // Math Example 1 for Cumstuffing: Pawn has 0.6 Stuffing for Cum, then 1.2 InsectSpunk -> total 1.8, 0.8 overflow; pawn ends with 1.0 InsectSpunk.
        // Math Example 2: 0.4 ChocciCum + 0.4 InsectSpunk + 0.4 Cum = 1.2, 0.2 overflow; overflow evenly subtracted -> 0.3, 0.3, 0.4.
    }
}
