    ...
    public class HediffComp_RandomlySpawnFilth : HediffComp
    {
        ...
        public override void CompPostTickInterval(ref float severityAdjustment, int delta)
        {
            ...
            foreach (var sexPart in Props.GetSexPartHediffs(parent.pawn))
            {
                ...
                {
                    var fluid = sexPart.GetPartComp().Fluid;
                    FilthMaker.TryMakeFilth(parent.pawn.PositionHeld, parent.pawn.Map, fluid.filth);
                    FilthProducerRegistry.Record(parent.pawn.Map, parent.pawn.PositionHeld, fluid.filth, parent.pawn);
                }
            }
        }
