...
public static class RJWLustIntegration
{
    ...
    {
        if (feeder == null || !ModIntegrationGates.RjwModActive) return;
    ...
    {
        if (pawn == null || need == null || !ModIntegrationGates.RjwModActive || !pawn.IsInLactatingState()) return;
        float cur = need.CurLevel;
...
public static class ChildcareHelper_SuckleFromLactatingPawn_Patch
{
    ...
    {
        return AccessTools.Method(AccessTools.TypeByName("MilkCum.Fluids.Lactation.Helpers.ChildcareHelper"), "SuckleFromLactatingPawn");
    }
...
public static class ChildcareHelper_Breastfeed_Patch
{
    static System.Reflection.MethodBase TargetMethod()
    {
        return AccessTools.Method(AccessTools.TypeByName("MilkCum.Fluids.Lactation.Helpers.ChildcareHelper"), "Breastfeed");
    }
