...
internal partial class MilkCumSettings
{
    ...
    internal static void ExposeRealismData()
    {
        ...
        Scribe_Values.Look(ref realismComplianceExponent, "EM.Realism.ComplianceExponent", 1.35f);
        Scribe_Values.Look(ref realismComplianceFloor, "EM.Realism.ComplianceFloor", 0.08f);
        Scribe_Values.Look(ref realismStretchBuffer, "EM.Realism.StretchBuffer", true);
        Scribe_Values.Look(ref realismStretchExtraFraction, "EM.Realism.StretchExtraFraction", 0.2f);
        Scribe_Values.Look(ref realismRjwStretchMilestone, "EM.Realism.RjwStretchMilestone", false);
        Scribe_Values.Look(ref realismRjwStretchMilestoneSteps, "EM.Realism.RjwStretchMilestoneSteps", 4f);
        Scribe_Values.Look(ref realismRjwStretchPerSideSync, "EM.Realism.RjwStretchPerSideSync", true);
        Scribe_Values.Look(ref realismMetabolicGate, "EM.Realism.MetabolicGate", true);
        Scribe_Values.Look(ref realismMetabolicHungerThreshold, "EM.Realism.MetabolicHungerThresh", 0.25f);
        Scribe_Values.Look(ref realismMetabolicThirstThreshold, "EM.Realism.MetabolicThirstThresh", 0.3f);
        Scribe_Values.Look(ref realismPoolFedSelf, "EM.Realism.PoolFedSelf", true);
        Scribe_Values.Look(ref realismPoolFedSelfFoodTarget, "EM.Realism.PoolFedFoodTarget", 0.35f);
        Scribe_Values.Look(ref realismPoolFedSelfMaxPoolFractionPer60, "EM.Realism.PoolFedMaxFrac60", 0.12f);
        Scribe_Values.Look(ref realismReflexLeak, "EM.Realism.ReflexLeak", true);
        Scribe_Values.Look(ref realismLeakBaseRate, "EM.Realism.LeakBaseRate", 0.04f);
        Scribe_Values.Look(ref realismLeakPressureScale, "EM.Realism.LeakPressureScale", 0.12f);
        Scribe_Values.Look(ref realismLeakFullnessScale, "EM.Realism.LeakFullnessScale", 0.35f);
        Scribe_Values.Look(ref realismLeakInflammationScale, "EM.Realism.LeakInflammationScale", 0.2f);
        Scribe_Values.Look(ref realismLeakVariance, "EM.Realism.LeakVariance", 0.15f);
        Scribe_Values.Look(ref realismEmptyStasisCoupling, "EM.Realism.EmptyStasisCoupling", true);
        Scribe_Values.Look(ref realismStasisLongFullScale, "EM.Realism.StasisLongFullScale", 0.35f);
        Scribe_Values.Look(ref realismStasisReliefScale, "EM.Realism.StasisReliefScale", 0.82f);
        Scribe_Values.Look(ref realismDrainReliefWindowTicks, "EM.Realism.DrainReliefWindowTicks", 18000);
        Scribe_Values.Look(ref realismDrainReliefInflowBoost, "EM.Realism.DrainReliefInflowBoost", 1.07f);
        Scribe_Values.Look(ref realismStimulusSource, "EM.Realism.StimulusSource", true);
        Scribe_Values.Look(ref realismBabyStimulusMult, "EM.Realism.BabyStimulusMult", 1.25f);
        Scribe_Values.Look(ref realismMachineStimulusMult, "EM.Realism.MachineStimulusMult", 0.85f);
        Scribe_Values.Look(ref realismStressLetdown, "EM.Realism.StressLetdown", true);
        Scribe_Values.Look(ref realismStressPainStart, "EM.Realism.StressPainStart", 0.08f);
        Scribe_Values.Look(ref realismStressPainMaxDrop, "EM.Realism.StressPainMaxDrop", 0.55f);
        Scribe_Values.Look(ref realismStressMoodThreshold, "EM.Realism.StressMoodThresh", 0.2f);
        Scribe_Values.Look(ref realismStressMoodMaxDrop, "EM.Realism.StressMoodMaxDrop", 0.35f);
        Scribe_Values.Look(ref realismWeaningCurve, "EM.Realism.WeaningCurve", true);
        Scribe_Values.Look(ref realismWeaningHalfLifeDays, "EM.Realism.WeaningHalfLifeDays", 1.5f);
