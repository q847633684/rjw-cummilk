    ...
    public class PassiveFluidGathererComp : ThingComp
    {
        ...
        public void FilthToItem()
        {
            ...
            foreach (var kv in copy)
            {
                ...
                EqualMilking.HarmonyPatches.CumpilationIntegration.CumProducerForNextSpawn = producer;
                try
                {
                ...
                {
                    EqualMilking.HarmonyPatches.CumpilationIntegration.CumProducerForNextSpawn = null;
                }
