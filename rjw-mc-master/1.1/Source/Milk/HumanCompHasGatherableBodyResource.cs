	...
	public abstract class HumanCompHasGatherableBodyResource : ThingComp
	{
		...
		public override void CompTick()
		{
			...
			if (this.Active)
			{
				...
				var t1 = rjw.Genital_Helper.get_breastsBPR(pawn);
				var t2 = rjw.Genital_Helper.get_PartsHediffList(pawn, t1);
				...
				float num = updateInterval / (this.GatherResourcesIntervalDays / this.BreastSizeDays * 60000f);
