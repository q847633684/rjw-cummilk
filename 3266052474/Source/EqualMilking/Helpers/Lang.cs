...
public static class Lang
{
    ...
    public static void LoadDefTranslations()
    {
        ...
        EMDefOf.EM_MilkingSpot.SetDefaultLabel(Lang.Join(Lang.Milking.CapitalizeFirst(), Lang.Spot));
        EMDefOf.EM_MilkingSpot.SetDefaultDesc(Lang.DesignatedFor.Replace("{0}", Lang.Join(Lang.Milking, $"({Lang.Self})")));
