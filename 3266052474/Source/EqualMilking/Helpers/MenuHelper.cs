...
public static class MenuHelper
{
    ...
    internal static IEnumerable<FloatMenuOption> BreastfeedMenuOptions(this Thing thing, Pawn actor)
    {
        ...
        if (actor.CanBreastfeedNow(pawn, out ChildcareUtility.BreastfeedFailReason? breastfeedFailReason))
        {
        ...
        else if (breastfeedFailReason != null)
        {
            yield return new FloatMenuOption("BabyCareBreastfeedUnable".Translate(pawn.Named("BABY")) + ": " + (breastfeedFailReason?.Translate(null, actor, pawn) ?? ""), null);
        }
        ...
        if (pawn.CanBreastfeedNow(actor, out ChildcareUtility.BreastfeedFailReason? suckleFailReason))
        {
        ...
        else if (suckleFailReason != null)
        {
            yield return new FloatMenuOption("CannotGenericWorkCustom".Translate(suckleText) + ": " + (suckleFailReason?.Translate(null, pawn, actor) ?? ""), null);
        }
    }
}