...
public class Widget_DefaultSetting
{
    ...
    public void Draw(Rect inRect)
    {
        ...
        listing.CheckboxLabeled(Lang.Milking, ref setting.allowMilking);
        listing.CheckboxLabeled(Lang.Milking + " (" + Lang.Self + ")", ref setting.allowMilkingSelf);
        listing.CheckboxLabeled(Lang.Breastfeed, ref setting.allowBreastFeeding);
        listing.CheckboxLabeled(Lang.Breastfeed + " (" + Lang.Adult + ")", ref setting.allowBreastFeedingAdult);
        listing.CheckboxLabeled(Lang.Fed, ref setting.canBeFed);
        listing.End();
    }
}
