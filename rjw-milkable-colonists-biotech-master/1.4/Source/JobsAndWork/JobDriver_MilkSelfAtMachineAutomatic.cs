...
namespace Milk
{
    ...
    [DefOf]
    public static class JobDefOfMilkSelfAtMachineAutomatic
    {
        public static JobDef MilkSelfAtMachineAutomatic;

        static JobDefOfMilkSelfAtMachineAutomatic()
        {
    ...
    public class JobDriver_MilkSelfAtMachineAutomatic : JobDriver_GatherHumanBodyResourcesAtMachineAutomatic
    {
    ...
    public abstract class JobDriver_GatherHumanBodyResourcesAtMachineAutomatic : JobDriver
    {
        ...
        private float WorkTick = MilkSettings.milkUpdateInterval * (1f / MilkSettings.workSpeedMult) * 0.5f;  //machines work twice as fast, so * 0.5
        ...
        **/
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            Thing partner = (Thing)this.job.GetTarget(TargetIndex.B).Thing;
            this.FailOn(() => !pawn.CanReserveAndReach(partner, PathEndMode.InteractionCell, Danger.Deadly));
            ...
            wait.tickAction = delegate ()
            {
                ...
                if (this.tickProgress > this.WorkTick)
                {
                    ...
                    myComp.TryMakeBottle(pawn, partner, 0.02f); //milking self. less fulfilling. pawn is their own partner. or something.
