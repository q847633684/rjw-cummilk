...
namespace Milk
{
    ...
    public abstract class WorkGiver_GatherHumanBodyResources : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            bool flag = pawn2 == null || !pawn2.RaceProps.Humanlike || pawn2.Drafted || pawn2.InAggroMentalState || CaravanFormingUtility.IsFormingCaravan(pawn2) || !pawn.IsDesignatedMilkAllowBfAdult() || !pawn.IsDesignatedMilkAllowManual();
            bool result;
            if (flag)
            {
                result = false;
