...
namespace Milk
{
    public class WorkGiver_MilkHuman : WorkGiver_GatherHumanBodyResources
    {
        protected override JobDef JobDef
        {
            get
            {
                return JobDefOfMilkHuman.MilkHuman;
            }
        }
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            bool flag = pawn2 == null || !pawn2.RaceProps.Humanlike || pawn2.InAggroMentalState || CaravanFormingUtility.IsFormingCaravan(pawn2) || !pawn2.IsDesignatedMilkAllowManual() || !pawn.IsDesignatedMilkWillManual();
            bool result;
            if (flag)
            {
                result = false;
        ...
        {
            return new Job(JobDefOfMilkHuman.MilkHuman, t);
        }
    }
}
