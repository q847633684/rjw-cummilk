...
namespace Milk
{
    ...
    [DefOf]
    public static class JobDefOfMilkSelfAtMachine
    {
        public static JobDef MilkSelfAtMachine;

        static JobDefOfMilkSelfAtMachine()
        {
            DefOfHelper.EnsureInitializedInCtor(typeof(JobDefOf));
        }
    }

    public class JobDriver_MilkSelfAtMachine : JobDriver_GatherHumanBodyResourcesAtMachine
    {
    ...
    public abstract class JobDriver_GatherHumanBodyResourcesAtMachine : JobDriver
    {
