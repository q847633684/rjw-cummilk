...
namespace Milk.MainTab.Checkbox
{
    ...
    public class PawnColumnWorker_MilkAllowMachine : PawnColumnWorker_Checkbox
    {
        ...
        {
            return pawn.CanDesignateMilkAllowMachine();
        }
        ...
        protected override bool GetValue(Pawn pawn)
        {
            ...
            return pawn.IsDesignatedMilkAllowMachine();
        }

        protected override void SetValue(Pawn pawn, bool value, PawnTable table)
        {
            if (value == this.GetValue(pawn)) return;
            pawn.ToggleMilkAllowMachine();
        }
    }
}