...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkAllowMachine : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkAllowMachine() ? pawn.IsDesignatedMilkAllowMachine() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkAllowMachine".Translate();
            ;
        }
    }
}