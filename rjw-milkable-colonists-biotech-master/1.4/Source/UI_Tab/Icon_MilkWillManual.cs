...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkWillManual : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkWillManual() ? pawn.IsDesignatedMilkWillManual() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkWillManual".Translate();
            ;
        }
    }
}