...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkAllowManual : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkAllowManual() ? pawn.IsDesignatedMilkAllowManual() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkAllowManual".Translate();
            ;
        }
    }
}