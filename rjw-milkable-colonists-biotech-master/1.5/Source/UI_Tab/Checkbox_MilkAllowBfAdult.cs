...
namespace Milk.MainTab.Checkbox
{
    ...
    public class PawnColumnWorker_MilkAllowBfAdult : PawnColumnWorker_Checkbox
    {
        ...
        {
            return pawn.CanDesignateMilkAllowBfAdult();
        }
        ...
        protected override bool GetValue(Pawn pawn)
        {
            ...
            return pawn.IsDesignatedMilkAllowBfAdult();
        }

        protected override void SetValue(Pawn pawn, bool value, PawnTable table)
        {
            if (value == this.GetValue(pawn)) return;
            pawn.ToggleMilkAllowBfAdult();
        }
    }
}