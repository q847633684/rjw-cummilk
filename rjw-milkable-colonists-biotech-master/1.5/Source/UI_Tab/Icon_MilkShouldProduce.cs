...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkShouldProduce : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkShouldProduce() ? pawn.IsDesignatedMilkShouldProduce() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkShouldProduce".Translate();
            ;
        }
    }
}