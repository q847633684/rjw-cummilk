...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkWillBfAdult : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkWillBfAdult() ? pawn.IsDesignatedMilkWillBfAdult() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkWillBfAdult".Translate();
            ;
        }
    }
}