...
namespace Milk.MainTab.Icon
{
    ...
    public class PawnColumnWorker_MilkAllowBfAdult : PawnColumnWorker_Icon
    {
        ...
        {
            return pawn.CanDesignateMilkAllowBfAdult() ? pawn.IsDesignatedMilkAllowBfAdult() ? comfortOn : comfortOff : comfortOff_nobg;
        }
        protected override string GetIconTip(Pawn pawn)
        {
            return "PawnColumnWorker_MilkAllowBfAdult".Translate();
            ;
        }
    }
}