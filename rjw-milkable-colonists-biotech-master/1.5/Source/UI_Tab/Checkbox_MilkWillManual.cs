...
namespace Milk.MainTab.Checkbox
{
    ...
    public class PawnColumnWorker_MilkWillManual : PawnColumnWorker_Checkbox
    {
        ...
        {
            return pawn.CanDesignateMilkWillManual();
        }
        ...
        protected override bool GetValue(Pawn pawn)
        {
            ...
            return pawn.IsDesignatedMilkWillManual();
        }

        protected override void SetValue(Pawn pawn, bool value, PawnTable table)
        {
            if (value == this.GetValue(pawn)) return;
            pawn.ToggleMilkWillManual();
        }
    }
}