...
| lactatingEfficiencyMultiplierPerStack | 每层 Lactating 堆叠的泌乳效率倍率 | 与 maxLactationStacks、流速/剩余天数 |
| milkAmountMultiplierPerStack | 每层堆叠的产奶量倍率 | 与 lactatingEfficiencyMultiplierPerStack |
